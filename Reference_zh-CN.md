...
* [一、整机指标](#整机指标)
    * [1.1、整机参数说明](#整机参数说明) 
    * [1.2、整机视图说明](#整机视图说明)
    * [1.3、整机预定义指标说明](#整机预定义指标说明)
    * [1.4、整机自定义指标说明](#整机自定义指标说明)
    * [1.5、整机实时模式说明](#整机实时模式说明)
* [二、多进程指标](#多进程指标)
    * [2.1、多进程参数说明](#多进程参数说明) 
    * [2.2、多进程视图说明](#多进程视图说明)
    * [2.3、多进程指标组合](#多进程指标组合)
...
* [三、单进程指标](#单进程指标)
    ...
    * [3.4、单进程指标说明](#单进程指标说明)  
* [四、整机load指标](#整机load指标)
    * [4.1、整机load参数说明](#整机load参数说明) 
    * [4.2、整机load指标说明](#整机load指标说明) 
    * [4.3、特异指标load5s深入说明](#特异指标load5s深入说明)   
* [五、Load详情指标](#Load详情指标)
    * [5.1、Load详情参数说明](#Load详情参数说明) 
    * [5.2、Load详情聚合指标说明](#Load详情聚合指标说明) 
    * [5.3、Load详情详细指标说明](#Load详情详细指标说明) 
* [六、数据采集器sresar](#数据采集器sresar)
    * [6.1、ssar工具简介](#ssar工具简介)
    * [6.2、ssar工作目录](#ssar工作目录)
    * [6.3、数据采集器通用选项配置](#数据采集器通用选项配置)
    * [6.4、数据采集器load选项配置](#数据采集器load选项配置)  
    * [6.5、数据采集器整机选项配置](#数据采集器整机选项配置)
* [七、通用查询器ssar](#通用查询器ssar)
    * [7.1、通用查询器整机指标配置](#通用查询器整机指标配置)
    * [7.2、通用查询器整机视图配置](#通用查询器整机视图配置)
    * [7.3、通用查询器整机指标组配置](#通用查询器整机指标组配置)
    * [7.4、通用查询器整机指标组作用优先级](#通用查询器整机指标组作用优先级)  
* [八、古典查询器tsar2](#古典查询器tsar2)
    * [8.1、时间范围类选项](#时间范围类选项)
        *  [8.1.1、date选项](#date选项)
        *  [8.1.2、ndays选项](#ndays选项)
        *  [8.1.3、watch选项](#watch选项)
        *  [8.1.4、live选项](#live选项)
    * [8.2、时间间隔选项interval](#时间间隔选项interval)
    * [8.3、数据指标大类选项](#数据指标大类选项)
        *  [8.3.1、cpu选项](#cpu选项)
        *  [8.3.2、mem选项](#mem选项)
        *  [8.3.3、swap选项](#swap选项)
        *  [8.3.4、tcp选项](#tcp选项)
        *  [8.3.5、udp选项](#udp选项)
        *  [8.3.6、traffic选项](#traffic选项)
        *  [8.3.7、io选项](#io选项)
        *  [8.3.8、pcsw选项](#pcsw选项)
        *  [8.3.9、tcpx选项](#tcpx选项)
        *  [8.3.10、load选项](#load选项)
    * [8.4、设备列表选项](#设备列表选项)
        *  [8.4.1、item选项](#item选项)
        *  [8.4.2、merge选项](#merge选项)
    * [8.5、指标类选项](#指标类选项)
        *  [8.5.1、spec选项](#spec选项)
        *  [8.5.2、spec选项](#spec选项)
* [九、tsar2创新指标](#tsar2创新指标)
    * [9.1、网络tcp扩展指标](#网络tcp扩展指标)
* [十、tsar2中断子命令irqtop](#tsar2中断子命令irqtop)
    * [10.1、输出指标项说明](#输出指标项说明)
    * [10.2、输入选项说明](#输入选项说明)
    * [10.3、大C选项参数特殊说明](#大C选项参数特殊说明)
    * [10.4、interrupts数据采集](#interrupts数据采集)  
* [十一、增强查询器ssar+](#增强查询器ssar+)
